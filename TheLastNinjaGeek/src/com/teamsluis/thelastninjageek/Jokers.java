...
public class Jokers {
	...
	public static void showJokers() {
		...
		if (Data.jokersAllowed == true) {
			...
			jokersWindow[0]
					.setToolTipText("<html><font color=red><p align = center>"
							+ "<b><u> [Ninja Hack]</b></u></p></font><br>"
							+ "You hack through the game,<br> " + "removing "
							+ "2 of the possible<br>"
			...
			if (Data.currentRound == 1) {
				...
				jokersWindow[1].addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						Data.playerUsedShuriken = true;
						bitsReward = 1 + (int) Math.floor(Math.random() * 4);
